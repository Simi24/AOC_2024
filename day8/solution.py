            ...
            for i in range(len(frequencyMap[key])):
                ...
                for j in range(i+1, len(frequencyMap[key])):
                    ...
                    while (a1[0] >= 0 and a1[0] < len(grid)) and (a1[1] >= 0 and a1[1] < len(grid[0])):
                        if antinodesMap[a1[0]][a1[1]] == False and grid[a1[0]][a1[1]] == ".":
                            print(key, a1)
                            antinodesMap[a1[0]][a1[1]] = True
                            antinodes += 1
                        a1 = (round(a1[0] - dx * distance), round(a1[1] - dy * distance))
                    
                    while (a2[0] >= 0 and a2[0] < len(grid)) and (a2[1] >= 0 and a2[1] < len(grid[0])):
                        if antinodesMap[a2[0]][a2[1]] == False and grid[a2[0]][a2[1]] == ".":
                            print(key, a2)
                            antinodesMap[a2[0]][a2[1]] = True
                            antinodes += 1
                        a2 = (round(a2[0] + dx * distance), round(a2[1] + dy * distance))
